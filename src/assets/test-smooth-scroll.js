...
;window.Modernizr = function(a, b, c) {
    ...
    var d = "2.7.0", e = {}, f = !0, g = b.documentElement, h = "modernizr", i = b.createElement(h), j = i.style, k, l = {}.toString, m = " -webkit- -moz- -o- -ms- ".split(" "), n = "Webkit Moz O ms", o = n.split(" "), p = n.toLowerCase().split(" "), q = {
...
(function(a, b, c) {
    ...
    b.Slideshow.prototype = {
        ...
        _getImageDim: function(a) {
            var b = new Image;
            b.src = a;
            var c = this.elWidth, d = this.$el.height(), e = d / c, f = b.width, g = b.height, h = g / f, i, j, k, l;
            if (e > h) {
                j = d;
                i = d / h
            } else {
...
!function(t) {
    ...
    t.fn.fitVids = function(e) {
        ...
        if (!document.getElementById("fit-vids-style")) {
            ...
            o.innerHTML = '<p>x</p><style id="fit-vids-style">' + a + "</style>",
...
!function(i) {
    i.fn.theiaStickySidebar = function(t) {
        ...
        this.each(function() {
            ...
            0 == e.stickySidebar.length && (e.sidebar.find("script").remove(),
            ...
            0 == d ? (e.stickySidebar.css("padding-top", 0),
            e.stickySidebarPaddingTop = 0) : e.stickySidebarPaddingTop = 1,
            0 == r ? (e.stickySidebar.css("padding-bottom", 0),
            ...
            e.onScroll = function(e) {
                if (e.stickySidebar.is(":visible")) {
                    ...
                    if (d >= e.container.offset().top + (e.paddingTop + e.marginTop - e.options.additionalMarginTop)) {
                        ...
                        "fixed" == e.stickySidebar.css("position") && (h += m),
                        h = m > 0 ? Math.min(h, g) : Math.max(h, n - e.stickySidebar.outerHeight()),
                        h = Math.max(h, f),
                    ...
                    if ("fixed" == r)
                        ...
                        var y = {};
                        "absolute" != e.stickySidebar.css("position") && (y.position = "absolute",
                        y.top = d + h - e.sidebar.offset().top - e.stickySidebarPaddingTop - e.stickySidebarPaddingBottom),
